...
df = pd.read_csv('/lus/lfs1aip2/projects/u6fo/pigen/data/alex_mp20_PDD.csv')
...
#bfs = ['/projects/u6fo/pigen/generated/PDDMIN/PIGEN_MLED9_Compactness07/denovo_9_07_g2_pdd.pickle']
...
for bfile in bfs:
    ...
    for j in tqdm(range(0, N_ref, BLOCK_REF)):
        ...
        D_block = (bf_cs.unsqueeze(1) - ref_chunk.unsqueeze(0)).abs().sum(-1) / K
