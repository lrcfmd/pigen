...
#SBATCH --job-name=PDD5
#SBATCH --output=outputs/slurm/PDDgen5.out
##SBATCH --output=outputs/slurm/PDDgen5_det.out
#SBATCH --nodes=1
#SBATCH --gpus=1
...
srun python pigen/generate.py \
        ...
        --save_path /home/u6fo/andrij.u6fo/pigen/generated/PDDMIN/gen_PDDMIN5 \
        --targets 5.0
#       --model_path /home/u6fo/andrij.u6fo/pigen/outputs/logs/PDDTRAIN_detach/2026-05-19-08-05-35/ \
#       --save_path /home/u6fo/andrij.u6fo/pigen/generated/PDDMIN/gen_PDDMIN5_det \
#       --targets 5.0
