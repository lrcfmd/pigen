...
##SBATCH --output=outputs/slurm/PDDgen3_det.out
#SBATCH --output=outputs/slurm/PDDgen3.out
#SBATCH --nodes=1
#SBATCH --gpus=1
...
srun python pigen/generate.py \
        ...
        --save_path /home/u6fo/andrij.u6fo/pigen/generated/PDDMIN/gen_PDDMIN3 \
        --targets 3.0 

#       --model_path /home/u6fo/andrij.u6fo/pigen/outputs/logs/PDDTRAIN_detach/2026-05-19-08-05-35/ \
#       --save_path /home/u6fo/andrij.u6fo/pigen/generated/PDDMIN/gen_PDDMIN3_det \
#       --targets 3.0 
#--batch_size 10 \
