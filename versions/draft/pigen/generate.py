...
with open(f'{PROJECT_ROOT}/pigen/train_dist.json') as f:
...
def main(
    model_path=f'{config.PATHS.LOG_DIR}/density_test',
    save_path=None,
    dataset='full_data',
    step_lr=5e-6,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='full_data', help='Refernce dataaset to define p(N) where N is the number of atoms in the material to be generated.')
